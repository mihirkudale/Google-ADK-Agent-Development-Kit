...
initial_state = {
    "name": "mihir",
    "data":'''
    I am mihir, a software developer with 5 years of experience in full-stack development.
...
USER_ID = "mihir"
SESSION_ID = 'mihir_session'  # str(uuid.uuid4())  # Use a unique session ID in production
